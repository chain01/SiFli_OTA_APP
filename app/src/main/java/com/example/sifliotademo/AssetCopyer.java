...
//        String[] lists = assetManager.list("nand");
...
//            files.add(path);
//        }
        files.add("nand/ctrl_packet.bin");
        files.add("nand/outER_IROM1.bin");
        files.add("nand/diff.zip");
        files.add("norv1/ctrl_packet.bin");
        files.add("norv1/outapp.bin");
//        for (String f: lists) {
//            files.add(f);
//        }
        return files;
